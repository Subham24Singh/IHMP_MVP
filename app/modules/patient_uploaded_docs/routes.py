...
from app.modules.patient_uploaded_docs.models import PatientUploadedDocs
from app.modules.patient_uploaded_docs.schema import PatientUploadedDocsSchema
